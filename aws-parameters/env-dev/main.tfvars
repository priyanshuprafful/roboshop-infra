parameters = [
  ...
  {name = "dev.frontend.catalogue_url", value = "http://catalogue-dev.saraldevops.online:80/" , type = "String"},
  {name = "dev.frontend.user_url", value = "http://user-dev.saraldevops.online:80/" , type = "String"},
  {name = "dev.frontend.cart_url", value = "http://cart-dev.saraldevops.online:80/" , type = "String"},
  {name = "dev.frontend.shipping_url", value = "http://shipping-dev.saraldevops.online:80/" , type = "String"},
  {name = "dev.frontend.payment_url", value = "http://payment-dev.saraldevops.online:80/" , type = "String"},
